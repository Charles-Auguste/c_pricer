...
MonteCarlo::MonteCarlo(size_t nb_sims, const PathSimulator& path_sim, const Pricing& pricing)
	: _number_simulations(nb_sims), _path_simulator_ptr(path_sim.clone()), _pricing_ptr(pricing.clone())
{
}
...
MdMonteCarlo::MdMonteCarlo(size_t nb_sims, const MdPathSimulator& path_sim, const Pricing& pricing)
	: _number_simulations(nb_sims), _path_simulator_ptr(path_sim.clone()), _pricing_ptr(pricing.clone())
{
}
